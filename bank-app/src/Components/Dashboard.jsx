...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchImageData = async () => {
      try {
        const response = await axios.get('http://your-api-url/image/your-image-id', {
            ...
            <div class="app-header-actions">
              <button class="user-profile">
                ...
                <span>
                  ...
                  {imageData && <img src={`data:image/jpeg;base64,${Buffer.from(imageData).toString('base64')}`} alt="Uploaded" />}
                  {/* <img src="https://assets.codepen.io/285131/almeria-logo.svg" /> */}
                </span>
              </button>
